...
//	private static String onnxLib = "libonnxruntime.so.1.20.1";
	...
	public void testYoloStepByStep() throws Throwable {
		...
		MemorySegment detector = initYolo(linker, yoloLibrary);

		detect(detector, imageMat);
	...
	private void detect(MemorySegment detector, Mat imageMat) throws Throwable {
